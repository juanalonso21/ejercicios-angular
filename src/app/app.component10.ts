// Ejercicio 10: Este ejercicio lo que hace es usar deferable view para cargar un componente de comentarios. El componente de comentarios se carga cuando el usuario hace scroll hasta la parte inferior del artículo. El componente de comentarios tiene un placeholder que se muestra mientras se cargan los comentarios y un loading que se muestra mientras se cargan los comentarios. El componente de comentarios tiene un input que recibe el id del artículo y lo muestra en la lista de comentarios.
